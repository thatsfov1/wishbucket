...
export default function HomePage() {
  ...
  const handleCreateWishlist = async (wishlistData: {
    ...
    try {
      ...
      if (!telegramUser?.id) {
        showTelegramAlert(
          "Please open this app from Telegram to create wishlists",
        );
        return;
      }
      ...
      console.log("Wishlist created:", newWishlist);
      ...
      showTelegramAlert(
        `Failed to create wishlist: ${err instanceof Error ? err.message : "Unknown error"}`,
      );

...
export default function WishlistsPage() {
  ...
  const { wishlists, setWishlists, addWishlist, setLoading, isLoading } = useStore();
    ...
    <div className="wishlists-container">
      ...
      <header className="wishlists-header">
        ...
        <button 
          ...
          onClick={() => { hapticFeedback.impact("medium"); setShowCreateModal(true); }}
        >
          ...
          <div className="wishlists-list">
            {wishlists.map((wishlist, index) => (
              <div 
                ...
                onClick={() => { hapticFeedback.impact("light"); navigate(`/wishlists/${wishlist.id}`); }}
              >
                ...
                <div className="wishlist-info">
                  ...
                  <p className="wishlist-meta">
                    ...
                    {wishlist.description && ` · ${wishlist.description.slice(0, 30)}${wishlist.description.length > 30 ? '...' : ''}`}
                  </p>
                </div>
